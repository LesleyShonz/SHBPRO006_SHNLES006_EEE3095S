...
// Global variable to keep track of the current waveform
enum WaveformType {
    Sine,
    Sawtooth,
    Triangle
};
enum WaveformType currentWaveform = Sine;
// sin lookup table
...
void EXTI0_1_IRQHandler(void)
{
	// TODO: Debounce using HAL_GetTick()
	 ...
	 if (currentTime - lastButtonPressTime < 100) {
	     ...
	     return;  // Ignore button presses within 100ms of the last press
	    }
